...
1	if(yes(1:1).eq.'y')then
	...
	open(unit=16,file=sname(1:kn)//'_arr.smp')
	open(unit=19,file=sname(1:kn)//'_log.smp')
	open(unit=11,file=sname(1:kn)//'_tmp.in')
	open(unit=21,file=sname(1:kn)//'_age-sd.smp')
	open(unit=22,file=sname(1:kn)//'_age-cl.smp')
	open(unit=23,file=sname(1:kn)//'_fj.in')
      open(unit=24,file=sname(1:kn)//'_sig.in')
      open(unit=25,file=sname(1:kn)//'_age.in')
