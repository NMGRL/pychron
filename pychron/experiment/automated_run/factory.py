...
class AutomatedRunFactory(DVCAble, PersistenceLoggable):
    ...
    pattributes = ('collection_time_zero_offset',
                   ...
                   'extract_value', 'extract_units', 'cleanup', 'lighting',
    ...
    def _get_run_attr(self):
        return ['position',
                'extract_value', 'extract_units', 'cleanup', 'duration', 'lighting',
                'use_cdd_warming',
                'conditionals_str',
    ...
    def _load_defaults(self, ln, attrs=None, overwrite=True):
        if attrs is None:
            attrs = ('extract_value', 'extract_units',
                     'cleanup', 'duration', 'beam_diameter', 'lighting')
    ...
    @on_trait_change('''cleanup, duration, extract_value, ramp_duration, lighting,
collection_time_zero_offset,
use_cdd_warming,
extract_units,
pattern,
