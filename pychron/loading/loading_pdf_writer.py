...
class LoadingPDFWriter(BasePDFTableWriter):
    ...
    def _build(self, doc, positions, grouped_positions, component, meta):
        ...
        lm = doc.leftMargin
        bm = doc.bottomMargin + doc.height * 0.333
        ...
        rbottom = Frame(lm + doc.width / 2.0, bm, fw, fh)
    ...
    def _make_notes_table(self, positions):
        ...
        for pi in positions:
            ...
            if idx % 2 != 0:
                ts.add("BACKGROUND", (0, idx + 1), (-1, idx + 1), colors.lightgrey)
            idx += 1
