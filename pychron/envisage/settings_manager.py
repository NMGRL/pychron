...
class SettingsManager(Loggable):
    ...
    help_str = Str('Select a <b>Package</b> to load available <b>Settings</b>.<br>Select one or more <b>Settings</b> '
    ...
    def traits_view(self):
        v = View(VGroup(BorderVGroup(CustomLabel('help_str', size=14),),
                        HGroup(VGroup(HGroup(icon_button_editor('add_package_button', 'add')),
                                      BorderVGroup(UItem('package_names',
