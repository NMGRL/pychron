...
class FurnaceFirmwareProtocol(ServiceProtocol):
    def __init__(self, manager, addr):
        ...
        misc_services = (
            ("GetLabTemperature", manager.get_lab_temperature),
        ...
        controller_services = (
            ("GetTemperature", manager.get_temperature),
        ...
        dump_services = (
            ("LowerFunnel", manager.lower_funnel),
        ...
        bakeout_services = (
            ("GetBakeoutSetpoint", manager.get_bakeout_setpoint),
