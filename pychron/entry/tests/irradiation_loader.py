...
class XLSIrradiationLoaderLoadTestCase(unittest.TestCase):
    ...
    def test_add_level(self):
        ...
        obj = self.loader.db.get_irradiation_level("NM-1000", "A")
        self.assertTupleEqual((obj.irradiation.name, obj.name), ("NM-1000", "A"))
    ...
    def test_add_position(self):
        ...
        self.assertTupleEqual(
            (obj.position, obj.level.name, obj.level.irradiation.name, obj.identifier),
            (1, "A", "NM-1000", "1000"),
        )
...
class XLSIrradiationLoaderParseTestCase(unittest.TestCase):
    ...
    def test_iteration3(self):
        ...
        self.assertListEqual(
            [(i[0].value, i[1].value) for i in irrads[0]],
            [("NM-1000", "A"), ("NM-1000", "B")],
        )
    ...
    def test_iteration4(self):
        ...
        self.assertListEqual(
            [(i[0].value, i[1].value) for i in irrads[1]], [("NM-1001", "A"), ("", "B")]
        )
    ...
    def test_iteration4(self):
        ...
        self.assertListEqual(
            [(i[0].value, i[1].value) for i in irrads[1]],
            [("NM-1001", "A"), ("NM-1001", "B")],
        )
    ...
    def test_add_chronologies(self):
        self.loader.add_irradiations()
        self.assertListEqual(
            self.loader.added_chronologies,
            [
...
class SimilarTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.db = dvc_db_factory(
            os.path.join(get_data_dir(), "similar.db"), remove=False, echo=False
        )
