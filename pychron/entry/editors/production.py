...
class IrradiationProduction(HasTraits):
    ...
    @on_trait_change(
        """k+:[value,error],ca+:[value,error],cl+:[value,error],
Ca_K:[value,error],Cl_K:[value,error],note"""
    ...
    def get_params(self):
        params = {}
        keys = ["k4039", "k3839", "k3739", "ca3937", "ca3837", "ca3637", "cl3638"]
    ...
    def create_from_dict(self, d):
        for attr in ("K4039", "K3839", "K3739", "Ca3937", "Ca3837", "Ca3637", "Cl3638"):
