...
class SampleEntryPane(TraitsTaskPane):
    def traits_view(self):
        ...
        current = VGroup(
            HGroup(
                UItem(
                    "sample_filter_attr", editor=EnumEditor(name="sample_filter_attrs")
                ),
                UItem("sample_filter"),
            ),
            VSplit(
    ...
    def traits_view(self):
        pigrp = HGroup(
            UItem(
                ...
                editor=ComboboxEditor(name="principal_investigators", use_filter=False),
            ),
            icon_button_editor(
                "configure_pi_button",
                "cog",
            ...
            icon_button_editor(
                "add_principal_investigator_button",
                "add",
        ...
        prgrp = HGroup(
            ...
            UItem(
                ...
                tooltip="Generate a default name for this project",
            ),
            UItem(
                "set_optionals_button",
                tooltip="Set optional values for current project",
            ),
            icon_button_editor(
                "add_project_button",
                "add",
        ...
        mgrp = HGroup(
            ...
            UItem(
                "grainsize", editor=ComboboxEditor(name="grainsizes", use_filter=False)
            ),
        ...
        sgrp = VGroup(
            HGroup(
                UItem("sample"),
                icon_button_editor(
                    "configure_sample_button",
                    "cog",
                    tooltip="Set additional sample " "attributes",
                ),
                icon_button_editor(
                    "add_sample_button",
                    "add",
            ...
            HGroup(
                Item("igsn", label="IGSN"),
                icon_button_editor(
                    "get_igsn_button",
                    "world",
                    tooltip="Fetch a new IGSN from SESAR for " "this sample",
                ),
            ),
        ...
        v = View(VGroup(pigrp, prgrp, mgrp, sgrp, CustomLabel("pane.help_str")))
        return v
