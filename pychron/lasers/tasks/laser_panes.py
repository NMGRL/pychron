...
class StageControlPane(TraitsDockPane):
    ...
    def traits_view(self):
        ...
        chgrp = VGroup(HGroup(Item('canvas.show_laser_position', label='Show Current'),
                       ...
                       label='Crosshairs',
                       show_border=True)
        cngrp = VGroup(Item('canvas.show_bounds_rect', label='Show Bounds Rectangle'),
        ...
        if mode != 'client':
            ...
            tc_grp = VGroup(UItem('tray_calibration.style',
                            ...
                            HGroup(UItem('tray_calibration.calibrate',
                                         ...
                                         width=-125),
                                   UItem('tray_calibration.add_holes_button', label='Add Holes'),
                                   UItem('tray_calibration.reset_holes_button', label='Reset Holes')),
