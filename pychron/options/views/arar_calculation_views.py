...
class SpectrumSubOptions(SubOptions):
    def traits_view(self):
        integrated = BorderVGroup(Item('integrated_include_omitted', label='Include Omitted'),
                                  label='Integrated')
...
class IsochronSubOptions(SubOptions):
    def traits_view(self):
        filtering = BorderVGroup(Item('isochron_omit_non_plateau', label='Omit Non Plateau'),
