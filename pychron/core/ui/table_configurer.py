...
class TableConfigurer(HasTraits):
    ...
    def _get_column_width_group(self):
        ...
        widths_grp = BorderVGroup(
            HGroup(VGroup(*aitems), VGroup(*bitems)), label="Column Widths"
        )
        return widths_grp
        ...
        v = okcancel_view(
            VGroup(
                HGroup(
                    ...
                    UItem("toggle_sparse", tooltip="Display only Sparse Column Set"),
                    UItem(
                        "default_button",
