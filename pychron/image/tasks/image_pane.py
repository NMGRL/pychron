...
from traitsui.api import View, Item, UItem, TabularEditor, VGroup
# ============= standard library imports ========================
# ============= local library imports  ==========================
from pychron.core.ui.qt.tabular_editors import FilterTabularEditor
from pychron.envisage.browser.adapters import SampleAdapter, ProjectAdapter, LabnumberAdapter


class SampleImagePane(TraitsTaskPane):
