...
TOUPCAM_EVENT_IMAGE = (
    0x0004  # live image arrived, use Toupcam_PullImage to get this image
)
TOUPCAM_EVENT_STILLIMAGE = (
    0x0005  # snap (still) frame arrived, use Toupcam_PullStillImage to get this frame
)
...
TOUPCAM_OPTION_NOFRAME_TIMEOUT = (
    0x01  # no frame timeout: 1 = enable; 0 = disable. default: disable
)
TOUPCAM_OPTION_THREAD_PRIORITY = (
...
TOUPCAM_OPTION_PRECISE_FRAMERATE = (
...
TOUPCAM_OPTION_FRONTEND_DEQUE_LENGTH = (
    0x31  # frontend frame buffer deque length, range: [2, 1024], default: 3
)
TOUPCAM_OPTION_FRAME_DEQUE_LENGTH = (
    0x31  # alias of TOUPCAM_OPTION_FRONTEND_DEQUE_LENGTH
)
TOUPCAM_OPTION_MIN_PRECISE_FRAMERATE = (
...
TOUPCAM_IOCONTROLTYPE_GET_SUPPORTEDMODE = (
...
TOUPCAM_IOCONTROLTYPE_GET_DEBOUNCERTIME = (
...
TOUPCAM_IOCONTROLTYPE_GET_TRIGGERDELAY = (
...
TOUPCAM_IOCONTROLTYPE_GET_COUNTERSOURCE = (
...
TOUPCAM_IOCONTROLTYPE_GET_PWMSOURCE = (
...
TOUPCAM_IOCONTROLTYPE_GET_STROBEDELAYMODE = (
...
TOUPCAM_IOCONTROLTYPE_GET_STROBEDURATION = (
...
class Toupcam:
    ...
    def StartPullModeWithCallback(self, fun, ctx):
        ...
        self.__lib.Toupcam_StartPullModeWithCallback(
    ...
    def PullImageWithRowPitchV2(self, pImageData, bits, rowPitch, pInfo):
        ...
        """
        if pInfo is None:
            self.__lib.Toupcam_PullImageWithRowPitchV2(
    ...
    def PullStillImageWithRowPitchV2(self, pImageData, bits, rowPitch, pInfo):
        if pInfo is None:
            self.__lib.Toupcam_PullStillImageWithRowPitchV2(
                self.__h, pImageData, bits, rowPitch, None
            )
        else:
            x = __FrameInfoV2()
    ...
    def put_Size(self, nWidth, nHeight):
        self.__lib.Toupcam_put_Size(
            self.__h, ctypes.c_int(nWidth), ctypes.c_int(nHeight)
        )
    ...
    def get_Resolution(self, nResolutionIndex):
        ...
        x = ctypes.c_int(0)
        y = ctypes.c_int(0)
        self.__lib.Toupcam_get_Resolution(
    ...
    def get_PixelSize(self, nResolutionIndex):
        ...
        x = ctypes.c_float(0)
        y = ctypes.c_float(0)
        self.__lib.Toupcam_get_PixelSize(
            self.__h, ctypes.c_uint(nResolutionIndex), ctypes.byref(x), ctypes.byref(y)
        )
        return (x.value, y.value)
    ...
    def get_ResolutionRatio(self, nResolutionIndex):
        ...
        x = ctypes.c_int(0)
        y = ctypes.c_int(0)
        self.__lib.Toupcam_get_ResolutionRatio(
            self.__h, ctypes.c_uint(nResolutionIndex), ctypes.byref(x), ctypes.byref(y)
        )
        return (x.value, y.value)
    ...
    def put_MaxAutoExpoTimeAGain(self, maxTime, maxAGain):
        return self.__lib.Toupcam_put_MaxAutoExpoTimeAGain(
    ...
    def get_MinAutoExpoTimeAGain(self):
        x = ctypes.c_uint(0)
        y = ctypes.c_ushort(0)
        self.__lib.Toupcam_get_MinAutoExpoTimeAGain(
            self.__h, ctypes.byref(x), ctypes.byref(y)
        )
        return (x.value, y.value)
    ...
    def get_ExpTimeRange(self):
        ...
        y = ctypes.c_uint(0)
        z = ctypes.c_uint(0)
        self.__lib.Toupcam_get_ExpTimeRange(
    ...
    def get_ExpoAGainRange(self):
        ...
        y = ctypes.c_ushort(0)
        z = ctypes.c_ushort(0)
        self.__lib.Toupcam_get_ExpoAGainRange(
            self.__h, ctypes.byref(x), ctypes.byref(y), ctypes.byref(z)
        )
        return (x.value, y.value, z.value)
    ...
    def put_TempTint(self, nTemp, nTint):
        ...
        self.__lib.Toupcam_put_TempTint(
    ...
    def get_StillResolution(self, nResolutionIndex):
        x = ctypes.c_int(0)
        y = ctypes.c_int(0)
        self.__lib.Toupcam_get_StillResolution(
            self.__h, ctypes.c_uint(nResolutionIndex), ctypes.byref(x), ctypes.byref(y)
        )
        return (x.value, y.value)
    ...
    def put_LEDState(self, iLed, iState, iPeriod):
        ...
        """
        self.__lib.Toupcam_put_LEDState(
            self.__h,
    ...
    def get_FrameRate(self):
        ...
        y = ctypes.c_uint(0)
        z = ctypes.c_uint(0)
        self.__lib.Toupcam_get_FrameRate(
            self.__h, ctypes.byref(x), ctypes.byref(y), ctypes.byref(z)
        )
        return (x.value, y.value, z.value)
    ...
    def IoControl(self, ioLineNumber, eType, outVal):
        x = ctypes.c_int(0)
        self.__lib.Toupcam_IoControl(
            self.__h,
            ctypes.c_uint(ioLineNumber),
            ctypes.c_uint(eType),
            ctypes.c_int(outVal),
            ctypes.byref(x),
        )
    ...
    def Update(cls, camId, filePath, pFun):
        ...
        cls.__progress = pFun
        if sys.platform == "win32":
            return cls.__lib.Toupcam_Update(
                camId,
                filePath,
    ...
    def __initlib(cls):
        if cls.__lib is None:
            try:
                ...
                if sys.platform == "win32":
                    cls.__lib = ctypes.windll.LoadLibrary(
                        os.path.join(dir, "toupcam.dll")
                    )
                elif sys.platform.startswith("linux"):
                    cls.__lib = ctypes.cdll.LoadLibrary(
                        os.path.join(dir, "libtoupcam.so")
                    )
                else:
                    cls.__lib = ctypes.cdll.LoadLibrary(
                        os.path.join(dir, "libtoupcam.dylib")
                    )
            except OSError:
                pass
            ...
            if sys.platform == "win32":
                ...
                cls.__lib.Toupcam_Update.argtypes = [
                    ctypes.c_wchar_p,
                    ctypes.c_wchar_p,
            ...
            cls.__lib.Toupcam_StartPullModeWithCallback.argtypes = [
                ctypes.c_void_p,
            ...
            cls.__lib.Toupcam_PullImageV2.argtypes = [
                ctypes.c_void_p,
                ctypes.c_char_p,
                ctypes.c_int,
            ...
            cls.__lib.Toupcam_PullStillImageV2.argtypes = [
                ctypes.c_void_p,
                ctypes.c_char_p,
                ctypes.c_int,
                ctypes.POINTER(cls.__FrameInfoV2),
            ...
            cls.__lib.Toupcam_PullImageWithRowPitchV2.argtypes = [
                ctypes.c_void_p,
                ctypes.c_char_p,
                ctypes.c_int,
                ctypes.c_int,
            ...
            cls.__lib.Toupcam_PullStillImageWithRowPitchV2.argtypes = [
                ctypes.c_void_p,
                ctypes.c_char_p,
                ctypes.c_int,
                ctypes.c_int,
            ...
            cls.__lib.Toupcam_SnapN.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_uint,
            ]
            ...
            cls.__lib.Toupcam_put_Size.argtypes = [
                ctypes.c_void_p,
                ctypes.c_int,
                ctypes.c_int,
            ]
            ...
            cls.__lib.Toupcam_get_Size.argtypes = [
                ctypes.c_void_p,
            ...
            cls.__lib.Toupcam_get_Resolution.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.POINTER(ctypes.c_int),
                ctypes.POINTER(ctypes.c_int),
            ...
            cls.__lib.Toupcam_get_ResolutionRatio.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.POINTER(ctypes.c_int),
                ctypes.POINTER(ctypes.c_int),
            ...
            cls.__lib.Toupcam_get_RawFormat.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_uint),
                ctypes.POINTER(ctypes.c_uint),
            ]
            ...
            cls.__lib.Toupcam_put_AutoExpoTarget.argtypes = [
                ctypes.c_void_p,
                ctypes.c_int,
            ]
            ...
            cls.__lib.Toupcam_put_MaxAutoExpoTimeAGain.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_ushort,
            ]
            ...
            cls.__lib.Toupcam_get_MaxAutoExpoTimeAGain.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_uint),
                ctypes.POINTER(ctypes.c_ushort),
            ]
            ...
            cls.__lib.Toupcam_put_MinAutoExpoTimeAGain.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_ushort,
            ]
            ...
            cls.__lib.Toupcam_get_MinAutoExpoTimeAGain.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_uint),
                ctypes.POINTER(ctypes.c_ushort),
            ]
            ...
            cls.__lib.Toupcam_AwbOnce.argtypes = [
                ctypes.c_void_p,
                ctypes.c_void_p,
                ctypes.c_void_p,
            ]
            ...
            cls.__lib.Toupcam_AwbInit.argtypes = [
                ctypes.c_void_p,
                ctypes.c_void_p,
                ctypes.c_void_p,
            ]
            ...
            cls.__lib.Toupcam_put_TempTint.argtypes = [
                ctypes.c_void_p,
                ctypes.c_int,
                ctypes.c_int,
            ]
            ...
            cls.__lib.Toupcam_get_TempTint.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_put_WhiteBalanceGain.argtypes = [
                ctypes.c_void_p,
                (ctypes.c_int * 3),
            ]
            ...
            if sys.platform == "win32":
                cls.__lib.Toupcam_FfcExport.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_wchar_p,
                ]
                cls.__lib.Toupcam_FfcImport.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_wchar_p,
                ]
                cls.__lib.Toupcam_DfcExport.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_wchar_p,
                ]
                cls.__lib.Toupcam_DfcImport.argtypes = [
                    ctypes.c_void_p,
                    ctypes.c_wchar_p,
                ]
            else:
            ...
            cls.__lib.Toupcam_get_Hue.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_Saturation.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_Brightness.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_Contrast.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_Gamma.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_Chrome.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_VFlip.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_HFlip.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_Negative.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_Speed.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_ushort),
            ]
            ...
            cls.__lib.Toupcam_get_HZ.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_get_StillResolution.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.POINTER(ctypes.c_int),
                ctypes.POINTER(ctypes.c_int),
            ...
            cls.__lib.Toupcam_get_RealTime.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_put_LevelRange.argtypes = [
                ctypes.c_void_p,
                (ctypes.c_ushort * 4),
                (ctypes.c_ushort * 4),
            ]
            ...
            cls.__lib.Toupcam_get_LevelRange.argtypes = [
                ctypes.c_void_p,
                (ctypes.c_ushort * 4),
                (ctypes.c_ushort * 4),
            ]
            ...
            cls.__lib.Toupcam_put_LevelRangeV2.argtypes = [
                ctypes.c_void_p,
                ctypes.c_ushort,
                ctypes.POINTER(cls.__RECT),
                (ctypes.c_ushort * 4),
            ...
            cls.__lib.Toupcam_get_LevelRangeV2.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_ushort),
                ctypes.POINTER(cls.__RECT),
                (ctypes.c_ushort * 4),
            ...
            cls.__lib.Toupcam_put_LEDState.argtypes = [
                ctypes.c_void_p,
                ctypes.c_ushort,
                ctypes.c_ushort,
                ctypes.c_ushort,
            ...
            cls.__lib.Toupcam_write_EEPROM.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_char_p,
                ctypes.c_uint,
            ...
            cls.__lib.Toupcam_read_EEPROM.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_char_p,
                ctypes.c_uint,
            ...
            cls.__lib.Toupcam_read_Pipe.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_char_p,
                ctypes.c_uint,
            ...
            cls.__lib.Toupcam_write_Pipe.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_char_p,
                ctypes.c_uint,
            ...
            cls.__lib.Toupcam_put_Option.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_int,
            ]
            ...
            cls.__lib.Toupcam_get_Option.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.POINTER(ctypes.c_int),
            ]
            ...
            cls.__lib.Toupcam_put_Roi.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_uint,
                ctypes.c_uint,
            ...
            cls.__lib.Toupcam_get_Roi.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_uint),
                ctypes.POINTER(ctypes.c_uint),
                ctypes.POINTER(ctypes.c_uint),
            ...
            cls.__lib.Toupcam_get_AfParam.argtypes = [
                ctypes.c_void_p,
            ...
            cls.__lib.Toupcam_IoControl.argtypes = [
                ctypes.c_void_p,
                ctypes.c_uint,
                ctypes.c_uint,
                ctypes.c_int,
            ...
            cls.__lib.Toupcam_read_UART.argtypes = [
                ctypes.c_void_p,
                ctypes.c_char_p,
                ctypes.c_uint,
            ]
            ...
            cls.__lib.Toupcam_write_UART.argtypes = [
                ctypes.c_void_p,
                ctypes.c_char_p,
                ctypes.c_uint,
            ]
            ...
            cls.__lib.Toupcam_put_Linear.argtypes = [
                ctypes.c_void_p,
            ...
            cls.__lib.Toupcam_put_Curve.argtypes = [
                ctypes.c_void_p,
                ctypes.POINTER(ctypes.c_ubyte),
                ctypes.POINTER(ctypes.c_ushort),
            ]
            ...
            if sys.platform != "win32":
                ...
                cls.__lib.Toupcam_HotPlug.argtypes = [
