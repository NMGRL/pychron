...
class NewportAxis(Axis):
    ...
    def full_view(self):
        ...
        home_group = Group(
            Item("home_search_mode", editor=EnumEditor(values=HOME_SEARCH_MODES)),
        ...
        feed_forward_group = Group(
            Item("velocity_feed_forward_gain"),
            Item("acceleration_feed_forward_gain"),
            label="Feed-Forward",
        )
        loop_group = Group(pid_group, feed_forward_group, label="Loop")
        limit_group = Group(
            Item("software_negative_limit"),
        ...
        motion_group = Group(
            ...
            Item("jerk_rate"),
            Group("jog_high_speed", "jog_low_speed", label="Jog"),
            limit_group,
            label="Motion",
        )
        misc_group = Group(
            Item("maximum_following_error_threshold"),
        ...
        configuration_group = Group(
            Item("amplifier_io_configuration"),
