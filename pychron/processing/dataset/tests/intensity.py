...
class IntenistyMixin(object):
    @classmethod
    def setUpClass(cls):
        msid, sid,aid, pid=cls.set_analysis()
...
class IsochronTestCase(IntenistyMixin):
# ======= ratios
...
class SignalTestCase(IntenistyMixin):
# ======= signal err
...
class BaselineCorrectedTestCase(IntenistyMixin):
# ======= baseline only
...
class BlankTestCase(IntenistyMixin):
# ======= blanks
